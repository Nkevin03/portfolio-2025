...
export default function Home() {
  return (
    <div className="flex flex-wrap justify-between h-screen">
      <div className="w-full lg:w-3/12 px-5 py-10">
        <Left_Bar />
      </div>
      <div className="w-full lg:w-5/12 border-neutral-700 border-x px-5 py-10">
        <Center_Bar />
      </div>
      <div className="w-full lg:w-4/12 px-5 py-10">
        <Right_Bar />
      </div>
    </div>
  );
